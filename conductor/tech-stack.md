...
- Native Integration: tauri-plugin-dialog for native file pickers, trash crate for safe deletion, git2 for Git metadata, and dirs crate for cross-platform path resolution.